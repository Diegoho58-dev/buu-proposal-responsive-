...
# CONFIG
# -------------------------
app.config["SECRET_KEY"] = os.getenv("SECRET_KEY", "clave_dev_segura")

database_url = os.getenv("DATABASE_URL")

# ✅ IMPORTANTE (no rompe tu BD actual)
if not database_url:
...
@login_required
def wall():
    return render_template("wall.html", partner=get_chat_partner())
...
with app.app_context():
    ...
    # ✅ NO rompe datos, solo marca admin si existe
